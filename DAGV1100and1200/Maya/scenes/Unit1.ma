...
//Name: Unit1.ma
//Last modified: Thu, Aug 28, 2025 05:19:59 PM
//Codeset: 1252
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "9D641C97-4688-3A72-7553-E6B00DE6D49D";
createNode transform -s -n "persp";
	rename -uid "10115240-4DA1-9145-EE2E-879CA047E0B3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 33.884018045916989 22.498537673210347 31.819210893350032 ;
	setAttr ".r" -type "double3" 336.59999999994608 -673.19999999999038 2.3231087049511354e-15 ;
	setAttr ".rpt" -type "double3" -1.2762892251371356e-15 1.0407967381921452e-16 -5.114174064325299e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "BB795557-4F0C-C46C-4D8D-248C885ED01F";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 50.647671562331865;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -2.9624404437865923e-15 2.3839217466240084 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C396270E-4BDE-6D39-CB99-2EBA035ECEBD";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F252E9C4-41F7-B632-57D7-558B3F775207";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "26C1BAEC-45E3-2517-1BBC-D8B7A58E2257";
createNode displayLayerManager -n "layerManager";
	rename -uid "2653C7CC-4EB4-1F16-8701-3B9BE7D73AC6";
createNode displayLayer -n "defaultLayer";
	rename -uid "4E25A2C2-4376-7F7E-8039-418886FD78DE";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E8A2B79A-4323-C6D3-30D1-17BC48434E67";
