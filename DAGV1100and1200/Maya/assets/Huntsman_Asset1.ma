...
//Last modified: Fri, Oct 31, 2025 02:49:54 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "E648F912-4639-D141-192A-329769510655";
...
createNode transform -n "materialXStack1";
	rename -uid "6150E03F-465F-3957-3017-03AD1956075F";
createNode materialxStack -n "materialXStackShape1" -p "materialXStack1";
	rename -uid "90A656BA-4619-102C-8F5D-469E5CB32A90";
	setAttr -k off ".v";
	setAttr ".docs" -type "string" "[\n    {\n        \"document\": \"\",\n        \"name\": \"document1\"\n    }\n]\n";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FCF9E0B9-44BB-4D17-9E40-999023B4B427";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8F37A913-4F84-B011-5729-A7996754582E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DD2241F9-458B-9EA6-00D1-9AB5BFC23CA3";
createNode displayLayerManager -n "layerManager";
	rename -uid "E2435422-4666-1835-5A33-E6A8C715359D";
createNode displayLayer -n "defaultLayer";
	rename -uid "ED155738-4064-D339-6FE9-CB90516D4D98";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "97CAA711-4F82-78B2-ACE2-3BAD8AD04066";
...
createNode MaterialXSurfaceShader -n "Maya_Lambert1";
	rename -uid "AEF9DC85-4503-F80B-9E88-E8A7BE0AA138";
...
connectAttr "Maya_Lambert1.msg" "materialInfo2.m";
connectAttr "Maya_Lambert1.msg" "materialInfo2.t" -na;
